...
## READ ME: ########################################################
LOCAL_SRC_FILES += \
	core/java/android/app/smallscreen/ISmallScreenManager.aidl \
...
# AIDL files for iris recognition, add by sykean
LOCAL_SRC_FILES += \
	core/java/android/hardware/iris/IIrisDaemon.aidl \
	core/java/android/hardware/iris/IIrisDaemonCallback.aidl \
	core/java/android/hardware/iris/IIrisService.aidl \
	core/java/android/hardware/iris/IIrisServiceReceiver.aidl
...
# ============================================================
#LOCAL_STATIC_JAVA_LIBRARIES += alibaba
#include $(CLEAR_VARS)
#LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := alibaba:uhflib/fastjson-1.2.24.jar  
#include $(BUILD_MULTI_PREBUILT)
