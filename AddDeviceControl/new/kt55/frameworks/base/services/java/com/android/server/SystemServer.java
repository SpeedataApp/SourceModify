...
//spdata bairu
import com.android.server.smallscreen.SmallScreenService;
...
import com.android.control.DeviceControlService;
...
public final class SystemServer {
    ...
    private void startOtherServices() {
	    ...
	    //spdata bairu
            Slog.i(TAG, "smallscreen Service");
            SmallScreenService smallScreenService = new SmallScreenService(context);
            ServiceManager.addService(Context.SMALL_SCREEN,smallScreenService);
			
			
			DeviceControlService deviceControlService = new DeviceControlService(context);
            ServiceManager.addService(Context.DEVICE_CONTROL,deviceControlService);
